...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        text="AC", font=("Helvertica", 20,"bold"),width=28, padx=7,command=self.ClearDisplay)
        self.Clearbutton.grid(row=1,columnspan=4,sticky=W)

    ''' Space for backspace button
        self.Backspacebutton=Button(self,bg="#98DBC6",bd=12,
        tect="BACK",font=("Helvertica",20,"bold"), width=28,padx=33,pady=25,
        command=self.Backspace)
        self.Backspacebutton.grid(row=5,column=2,sticky=W)
    '''
